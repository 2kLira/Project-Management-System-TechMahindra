export default function LeaderboardPage() {
    return (
        <div style={s.page}>
            ...
            <div style={s.body}>
                <h1 style={{ fontSize:22, fontWeight:700, marginBottom:4 }}>Tabla de clasificación</h1>
                <p style={{ fontSize:13, color:'#888' }}>Gamificación de equipo — próximamente disponible.</p>
            </div>
        </div>
    );
}
